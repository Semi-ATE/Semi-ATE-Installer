...
Make sure that conda is installed via [maxiconda](https://github.com/Semi-ATE/maxiconda). This brings `conda` **and** `mamba` to your system. It is **IMPERATIVE** that this package is installed in the `base` environment! 
